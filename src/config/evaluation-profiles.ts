...
export const EVALUATION_PROFILES: EvaluationProfile[] = [
  {
    ...
    weights: {
      ...
      maintainability: 0, bugs_glitches: 0, scalability: 0, technical_debt: 0, dependency_health: 0,
      api_design: 0, database_design: 0, devops: 0,
      error_handling: 0, logging: 0, ai_integration: 0,
      bugs_glitches: 0, ui_consistency: 0, mobile_responsiveness: 0, seo: 0,
    },
  },
  {
    id: "startup-mvp",
    ...
    weights: {
      ...
      maintainability: 0.15, bugs_glitches: 0.05, scalability: 0.10, technical_debt: 0, dependency_health: 0,
      api_design: 0, database_design: 0, devops: 0,
      error_handling: 0, logging: 0, ai_integration: 0,
      bugs_glitches: 0, ui_consistency: 0, mobile_responsiveness: 0, seo: 0,
    },
  },
  {
    ...
    weights: {
      ...
      architecture: 0.15, documentation: 0.05,
      maintainability: 0.05, bugs_glitches: 0.05, scalability: 0.10, technical_debt: 0.05, dependency_health: 0.05,
  ...
  },
  {
    ...
    weights: {
      ...
      maintainability: 0.05, bugs_glitches: 0.05, scalability: 0, technical_debt: 0, dependency_health: 0,
      api_design: 0, database_design: 0, devops: 0,
      error_handling: 0, logging: 0, ai_integration: 0,
      bugs_glitches: 0, ui_consistency: 0, mobile_responsiveness: 0, seo: 0,
    },
  },
  {
    ...
    weights: {
      ...
      maintainability: 0.05, bugs_glitches: 0.05, scalability: 0.05, technical_debt: 0.05, dependency_health: 0.10,
      api_design: 0, database_design: 0, devops: 0,
      error_handling: 0, logging: 0, ai_integration: 0,
      bugs_glitches: 0, ui_consistency: 0, mobile_responsiveness: 0, seo: 0,
    },
  },
  {
    ...
    weights: {
      ...
      maintainability: 0.05, bugs_glitches: 0.05, scalability: 0.05, technical_debt: 0.03, dependency_health: 0.03,
      api_design: 0.03, database_design: 0.03, devops: 0.03,
      error_handling: 0.03, logging: 0.02, ai_integration: 0.02,
      bugs_glitches: 0.02, ui_consistency: 0.02, mobile_responsiveness: 0.02, seo: 0.02,
    },
  },
];
